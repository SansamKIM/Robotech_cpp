...
int main()
{
    ...
    cout << "lotto[1] Address: " << &lotto[0] << endl;
    cout << "lotto[2] Address: " << &lotto[0] << endl;
    cout << "lotto[3] Address: " << &lotto[0] << endl;
    cout << "lotto[4] Address: " << &lotto[0] << endl;
    cout << "lotto[5] Address: " << &lotto[0] << endl << endl;
